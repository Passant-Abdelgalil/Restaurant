...
public:
	...
	// Output Functions  ---------------------------
	void PrintMessage(string msg, int nLine, char writeHorizontal) const; // prints a message in the status bar
	...
	bool isDrawen(Order* pOrd); 
	//changed //to know if this feature is arleady drawn or not
};
